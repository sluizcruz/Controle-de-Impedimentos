            ...
            <div className="flex flex-wrap items-start gap-4">
                ...
                {!isStarted ? (
                    ...
                    <div className="flex flex-col">
                        <label className="block text-xs opacity-0 select-none">Status</label>
                ...
                <div className="flex-1 flex flex-col items-end">
                    <label className="block text-xs opacity-0 select-none">Ações</label>
                    <button
                        onClick={onExportPdf}
                        className="mt-1 px-3 py-2 bg-gray-100 text-gray-900 rounded-md text-sm hover:bg-gray-200 transition"
                    >
                        Exportar PDF
                    </button>
                </div>
